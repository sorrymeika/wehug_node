<div class="piano">
    ...
    <div class="piano_bd">
        <h4>01<b>简介</b></h4>
        <div class="piano_con" sn-binding="html:data.Content1"></div>
        <h4>02<b>寄语</b></h4>
        <div class="piano_con" sn-binding="html:data.Content2"></div>
        <h4>03<b>经历</b></h4>
        <div class="piano_con" sn-binding="html:data.Content3"></div>
    </div>
    <div class="piano_ft">
