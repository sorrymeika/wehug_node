...
<div class="main mycard">
    <ul class="mycard_con js_not_overdue" sn-binding="display:isOverdue|not">
        ...
        <li sn-repeat="item in data" sn-binding="class:item.VCA_DEDUCT_AMOUNT|cardClass:item.VCA_VCT_ID">
    ...
    <ul class="mycard_con js_overdue" sn-binding="display:isOverdue">
        <li class="dis" sn-repeat="item in data1" sn-binding="class:item.VCA_VCT_ID|equal:4:'free':''">
            <div class="price" sn-binding="html:item.VCA_DEDUCT_AMOUNT|currency,display:item.VCA_VCT_ID|equal:4|not"></div>
            <div class="name" sn-binding="html:item.VCA_NAME"><!--单笔订单满300可用--></div>
            <div class="time"><div class="hd">有效期</div><div class="con" sn-binding="html:item.CSV_END_DT|date:'yyyy/MM/dd'"></div></div>
        </li>
